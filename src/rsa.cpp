...
bool RSASignProvider::RSASign( const char* Msg,
                               size_t MsgLen,
...
bool RSAVerifyProvider::RSAVerify(unsigned char* MsgHash,
                                           size_t MsgHashLen,
                                           const char* Msg,
                                           size_t MsgLen,
                                           bool* Authentic) {
...
bool RSAVerifyProvider::RSAVerifyBase64(const std::string signature, const char* Msg,
        size_t MsgLen){
	unsigned char* MsgHash;
    size_t MsgHashLen;
    bool Authentic, res;
    Base64Decode(signature.c_str(), &MsgHash, & MsgHashLen);
    res = RSAVerify(MsgHash, MsgHashLen, Msg, MsgLen, &Authentic);
    return (Authentic);
}
